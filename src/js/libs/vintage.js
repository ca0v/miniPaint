...
class Vintage_class {
  ...
  adjust_color(canvas, level_red) {
    //level = [0, 200], default 70
  ...
  //decreasing contrast
  lower_contrast(canvas, level) {
    //level = [0, 50], default 15
    var context = canvas.getContext('2d');
    var W = canvas.width;
    var H = canvas.height;
  ...
  light_leak(canvas, level) {
    //level = [0, 150], default 90
    var context = canvas.getContext('2d');
    var W = canvas.width;
    var H = canvas.height;
    ...
    var radgrad = context.createRadialGradient(click_x, click_y, (distance * level) / 255, click_x, click_y, distance);
  ...
  //de-saturate
  chemicals(canvas, level) {
    //level = [0, 100], default 40
    var context = canvas.getContext('2d');
    var W = canvas.width;
    var H = canvas.height;
  ...
  exposure(canvas, level) {
    //level = [0, 150], default 80
    var context = canvas.getContext('2d');
    var W = canvas.width;
    var H = canvas.height;
  ...
  grains_big(canvas, level) {
    //level = [0, 50], default 20
    var context = canvas.getContext('2d');
    var W = canvas.width;
    var H = canvas.height;
  ...
  optics(canvas, param1, param2) {
    //param1 [0, 0.5], param2 [0, 0.7], default 0.3, 0.5
    var context = canvas.getContext('2d');
    var W = canvas.width;
    var H = canvas.height;
