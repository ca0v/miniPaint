...
class Image_decreaseColors_class {
    ...
    get_decreased_data(data, colors, greyscale) {
        ...
        //calculate weights
        var grey_palette = [];
        for (var i = 0; i < 256; i++) grey_palette[i] = 0;
        for (var i = 0; i < palette.length; i++) grey_palette[palette[i][3]]++;
        ...
        for (var max = 10 * 3; max < 100 * 3; max = max + 10 * 3) {
            ...
            for (var i = 0; i < palette.length; i++) {
                ...
                for (var j = 0; j < palette.length; j++) {
                    ...
                    if (i == j) continue;
                    if (
                        Math.abs(palette[i][0] - palette[j][0]) +
        ...
        for (var j = 0; j < H; j++) {
            for (var i = 0; i < W; i++) {
                ...
                for (var m = 0; m < p_n; m++) {
                    var diff =
                        Math.abs(palette[m][0] - imgData[k]) +
