...
class Image_translate_class {
    ...
    translate() {
        ...
        var pos_x = this.Helper.get_user_unit(
            config.layer.x,
            units,
            resolution,
        );
        var pos_y = this.Helper.get_user_unit(
            config.layer.y,
            units,
            resolution,
        );
        ...
        var settings = {
            ...
            on_finish: function (params) {
                var pos_x = _this.Helper.get_internal_unit(
                    params.x,
                    units,
                    resolution,
                );
                var pos_y = _this.Helper.get_internal_unit(
                    params.y,
                    units,
                    resolution,
                );
