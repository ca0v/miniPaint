...
class GUI_information_class {
    ...
    set_events() {
        ...
        document.getElementById('canvas_minipaint').addEventListener(
            'mousemove',
            function (e) {
                var global_pos = _this.Base_layers.get_world_coords(
                    e.offsetX,
                    e.offsetY,
                );
                ...
                mouse_x = _this.Helper.get_user_unit(
                    mouse_x,
                    _this.units,
                    _this.resolution,
                );
                mouse_y = _this.Helper.get_user_unit(
                    mouse_y,
                    _this.units,
                    _this.resolution,
                );
    ...
    show_size(force) {
        ...
        var width = this.Helper.get_user_unit(
            config.WIDTH,
            this.units,
            this.resolution,
        );
        ...
        document.getElementById('mouse_info_size').innerHTML =
            width + ' x ' + height;
        ...
        //show units
        var default_units = this.Tools_settings.get_setting(
            'default_units_short',
        );
